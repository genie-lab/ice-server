...
SELECT vi_id, vi_reply, vi_grp, vi_order, vi_dep, vi_parent, mb_id, vi_email, vi_name, vi_use, vi_password, vi_category, vi_title, vi_summary, vi_content, vi_view, vi_ip, vi_create_at, vi_update_at,
